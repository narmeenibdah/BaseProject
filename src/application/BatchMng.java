...
public class BatchMng {
    ...
    public static Parent getView() {
        ...
        table.getColumns().addAll(idCol, numCol, expCol, qtyCol, costCol, medCol, whCol);
        ...
        HBox topButtons = new HBox(10, btnAdd, btnDelete, btnSearch, btnUpdate, btnAll, btnExp);
