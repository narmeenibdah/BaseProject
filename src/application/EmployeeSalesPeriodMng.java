...
public class EmployeeSalesPeriodMng {
    ...
    private static void loadSales(TableView<Sale> table, int empId, String from, String to) {
        ...
        String sql =
            "SELECT Sale_ID, Sale_Date, Total_Amount, Branch_ID, Employee_ID, Customer_ID " +
            "FROM Sale " +
            "WHERE Employee_ID = ? " +
