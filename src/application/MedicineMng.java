...
public class MedicineMng {
	...
	public static Parent getView() {
		...
		Button btnNeverSold = new Button("Never Sold");
		...
		btnNeverSold.setOnAction(e -> loadNeverSoldMedicines(table));

		HBox crudButtons = new HBox(10, btnAdd, btnDelete, btnSearch, btnUpdate);
		crudButtons.setAlignment(Pos.CENTER);

		HBox queryButtons = new HBox(10, btnAll, btnLow, btnReq, btnNeverSold);
